                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="shipping-method-box">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="custom-control custom-radio">
                                        <input id="shippingOption2" name="shipping-option" class="custom-control-input" type="radio" wire:model='express_delivery'>
                                    ...
                                    <div class="custom-control custom-radio">
                                        <input id="shippingOption3" name="shipping-option" class="custom-control-input" type="radio" wire:model='next_day_delivery'>
                                        <label class="custom-control-label" for="shippingOption3">Next Business day</label> <span class="float-right font-weight-bold"> ₦4,000</span> </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-12">
                                ...
                                <div class="rounded p-2 bg-light">
                                    @foreach (Cart::content() as $item )
                                        ...
                                        <div class="media mb-2 border-bottom">
                                            <div class="media-body"> <a href="{{ route('product.details',['product_slug'=>$item->model->slug]) }}"> {{Str::ucfirst($item->model->name ) }}</a>
